...
export const Highlight = ({ children, className, delay }) => {
    return (
        <motion.span
            initial={{
            ...
            className={clsx(
                `relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-sky-300 to-blue-400 dark:from-indigo-500 dark:to-purple-500`,
                className
            )}
        >
            {children}
